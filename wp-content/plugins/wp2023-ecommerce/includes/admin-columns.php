...
// Hiển thị các cột của post type
...
add_action('manage_product_posts_custom_column', 'wp2023_admin_products_render_columns', 10, 2);
function wp2023_admin_products_render_columns($column, $post_id) {
    switch ($column) {
        case 'product_price':
