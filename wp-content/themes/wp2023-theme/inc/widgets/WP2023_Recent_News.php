...
class WP2023_Recent_News extends WP_Widget {
    public function __construct() {
        parent::__construct(
            ...
            array('description' => __('Widget recent news', 'text_domain'))
        );
    }
        ...
        <div class="blog__sidebar__recent">
            <?php if (count($posts)) : ?>
                <?php foreach ($posts as $post) : ?>
                    <a href="<?php echo get_the_permalink($post->ID) ?>" class="blog__sidebar__recent__item">
                        <div class="blog__sidebar__recent__item__pic">
                            <?php echo get_the_post_thumbnail($post->ID, [70,70]) ?>
                        </div>
...
$my_widget = new WP2023_Recent_News();
